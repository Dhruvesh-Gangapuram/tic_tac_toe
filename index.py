...
def start():
    ...
    btn = tk.Button(main_win, text="save", command=save , height = 2,width = 10,bg="#61ffef")
    ...
    def quiting():
        ...
        drawLines()
    btn2 = tk.Button(main_win, text="Start Game", command=quiting, height = 2,width = 10,bg="#61ffef")
...
def drawLines():
    ...
    player1_score_display = basefont.render(str(player_1[1]), True, (255,255,255))
    screen.blit(player1_score_display,(1100,150))
    player2_score_display = basefont.render(str(player_2[1]), True, (255,255,255))
    screen.blit(player2_score_display,(1100,450))

    displayDesc = smallfont.render("Click ENTER to start new game",True,(255,255,255))
    screen.blit(displayDesc,(1100,700))
    displayDesc2 = smallfont.render("and ESCAPE to exit this game",True,(255,255,255))
    ...
    for row in range(BOARD_ROWS):
        for col in range(BOARD_COLS):
            if board[row][col] == 1:
                ...
                pygame.draw.line(screen, CROSS_COLOR, ((col * 200 + SPACE)+80, (row * 200 + 200 - SPACE)+80), ((col * 200 + 200 - SPACE)+80, (row * 200 + SPACE)+80), CROSS_WIDTH)
                pygame.draw.line(screen, CROSS_COLOR, ((col * 200 + SPACE)+80, (row * 200 + SPACE)+80), ((col * 200 + 200 - SPACE)+80, (row * 200 + 200 - SPACE)+80), CROSS_WIDTH)
